...
let
  ...
  dmcfg = config.services.customXServer.displayManager;
...

{
  ...
  options = {
    ...
    services.customXServer.displayManager.slim = {

      enable = mkOption {
        type = types.bool;
        default = config.services.customXServer.enable;
        description = ''
  ...
  config = mkIf cfg.enable {
    ...
    services.customXServer.displayManager.job =
      { preStart =
          ''
    ...
    services.customXServer.displayManager.sessionCommands =
      ''
